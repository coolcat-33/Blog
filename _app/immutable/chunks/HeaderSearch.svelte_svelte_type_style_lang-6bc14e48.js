...
function FlatpickrInstance(element2, instanceConfig) {
  ...
  function bind(element3, event, handler, options) {
    if (event instanceof Array)
      return event.forEach((ev) => bind(element3, ev, handler, options));
    if (element3 instanceof Array)
      return element3.forEach((el) => bind(el, event, handler, options));
...
export { Button as B, trackModal as t, user as u };
